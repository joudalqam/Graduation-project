          ...
          <div class="timeline-item">
            ...
            <div class="timeline-item-inner">
              ...
              <div class="activity-stats">
                ...
                <button class="swap-btn" onclick="swapActivity(${pref.day}, ${i})">↻ Swap</button>
              </div>
            </div>
          </div>
        `).join('')}
...
function swapActivity(day, activityIndex) {
  alert(`Alternative suggestions for Day ${day}, Activity ${activityIndex + 1} would appear here.`);
}
